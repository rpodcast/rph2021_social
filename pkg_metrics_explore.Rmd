...
* [x] Which package has the most Rs in its name?
...
* [x] What package has the most contributors?
...
```{r}
most_exp <- arrange(df3, desc(npars_exported_md)) %>% select(package, npars_exported_md)
#most_exp
...
#### Which package has the most contributors?
...
#### Which package has the most R's in the name?
